...
let newStory = function(c){
    const url = 'http://47.113.231.211:3000/users/playedScript';
      ...
      .then(data => {
        ...
        if(data2==null){
          ...
          for (let i = 0; i < data2.length; i++) {
            name = data2[i].scriptName;
            backGround = data2[i].scriptBackground;
            ...
            <div class="sTop">
                ...
                <div class="sPic">
                    ...
                    <!-- 这个用来放标题 -->
                    <div class="sTittle" data-id='${data2[i].scriptId}'>
...
let jump =function(e){
  e.addEventListener('click',function(){
    value1= e.querySelector('.sTittle').getAttribute('data-id');
