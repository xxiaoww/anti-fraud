// 我的点赞http
let likeUrl = 'http://47.113.231.211:3000/users/like'

// 获取我的点赞的按钮

const mylikes = document.querySelector('.centerLike')
const change = document.querySelector('.centerIn>div:nth-of-type(2)')
// console.log(change)
const first_com = document.querySelector('.first-com')
mylikes.addEventListener('click', function() {
    first_com.style.display = 'block'
